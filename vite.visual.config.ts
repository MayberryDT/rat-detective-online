...
export default defineConfig({
  ...
  build: {
    ...
    emptyOutDir: true,
    rollupOptions: {
      input: [resolve(rootDir, 'test/visual/assignment-fixture.html'), resolve(rootDir, 'test/visual/capacity-render.html'), resolve(rootDir, 'test/visual/stage-prototype.html'), resolve(rootDir, 'test/visual/cheese-preview.html'), resolve(rootDir, 'test/visual/city-preview.html'), resolve(rootDir, 'test/visual/model-preview.html'), resolve(rootDir, 'test/visual/visual-fixture.html'), resolve(rootDir, 'test/visual/performance-fixture.html')],
    },
  },
});
