...
All world sounds now use [worldSoundGain](../src/audio/worldSoundGain.ts): guns, rat squeals/deaths, ragdoll impacts, briefcase contacts and remote ownership sounds, Popcorn, delayed thuds, the nearest flying-case buzz and Dispatch sirens. After human review, the complete distance fade is boosted 50% and capped at each cue’s original nearby volume: about 37% at 50 units, 9.8% at 100 and 1.8% at 250, including vertical separation. Gun base gain is .30 (previously .40). Personal UI/death-screen feedback and music remain local. The existing close foley and siren range fades are applied before that shared boost and ceiling. Foley, the case buzz and the playing siren follow changing distance; short one-shots use their event source. The buzz and siren smooth changes without repeatedly scheduling identical gains. See [checks and private preview](verification/sixteen-rat-tuning-2026-09-10.md).
