...
**Status:** Audit complete. Its protocol-15 implementation now lives on the isolated `codex/netplay-crispness` branch; see the [implementation receipt](verification/netplay-crispness-2026-09-12.md). It is not deployed and production remains unchanged.
