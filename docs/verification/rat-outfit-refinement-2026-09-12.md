...
**Later follow-up:** [the matching-arm study](rat-arm-study-2026-09-12.md) replaces the arm geometry, adds three off-hand options and enables city walking. Its r3 private preview supersedes the r2 link/version above. Geometry measurements here describe study 02.
