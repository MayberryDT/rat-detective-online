...
export class LandmarkArchitecture {
    ...
    constructor(private readonly scene:THREE.Scene,private readonly legacyLights=true){
    ...
    private interiors(){
        ...
        for(const hall of LANDMARK_INTERIORS){
            ...
            if(this.legacyLights)for(const y of hall.levels)for(const side of [-1,1])for(const end of [-1,1]){
