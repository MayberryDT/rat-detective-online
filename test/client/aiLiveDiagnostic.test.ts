...
it('keeps eleven dispersed rats pursuing one carrier through real city geometry',()=>{
 ...
 // This is a fixed-step navigation/progress regression, not a host CPU test.
 // Match Workers' frozen synchronous clock so the existing 96-expansion cap
 // determines work instead of unrelated parallel tests consuming the 2 ms slice.
 ...
 }finally{clock.mockRestore();ctl.dispose();}
},30000);
