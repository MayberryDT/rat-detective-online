...
async function observe(duration){
  ...
  const ready=new Promise((resolve,reject)=>{
    ...
    ws.on('open',()=>ws.send(JSON.stringify({type:'join',protocolVersion:5,name:'Launch Observer',appearance:{hatType:'fedora',hatColor:0xdc4a3c,furColor:0xe8b84d,coatColor:0xbe4545}})));
